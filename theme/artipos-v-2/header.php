<?php ob_start();
error_reporting(0);
session_start(); ini_set('session.cookie_lifetime', 432000); // 5 days ?><!DOCTYPE html>
<html lang="tr">
...
<head>
  ...
  <base href="<?php echo $siteyolu ?>theme/artipos-v-2/">
  ...
  <i class="iconly-Category icli nav-bar"></i>
    ...
    position: absolute;" alt="logo"></a>
      ...
      <div class="avatar-wrap">
        <a href="https://instagram.com/<?php echo $katlarcek['instagram']; ?>"> <span class="font-sm"><i class="fa fa-instagram"></i> </span></a> 
         </div>
    </header>
    <!-- Header End -->
 <style type="text/css">
    ...
    <div class="user-panel">
        ...
        <nav class="navigation">
          <ul>
            ...
            <li>
              <a href="category?masa_id_no=<?php echo $_GET['masa_id_no']; ?>" class="nav-link title-color font-sm">
                <i class="iconly-Category icli"></i>
                <span style="font-family: monospace;">Kategoriler</span>
              </a>
              <a class="arrow" href="category?masa_id_no=<?php echo $_GET['masa_id_no']; ?>"><i data-feather="chevron-right"></i></a>
            </li>

...
$datacon2->execute(array(  ));
       ...
       while ($kategoricek=$datacon2 -> fetch(PDO:: FETCH_ASSOC)){   ?>
          <div class="product-list media" style="background-color: #f6f6f6">
            <a href="kategoriler-<?php echo $kategoricek['seo_url'] ?>?masa_id_no=<?php echo $_GET['masa_id_no']; ?>">
            	<img src="timthumb?src=<?php echo $siteyolu; ?><?php echo  $kategoricek['ust_kategori_resim']; ?>&w=200&h=130&zc=4&a=tc" class="img-fluid" alt="offer"></a>
            <div  style=" width: auto;" class="media-body">
              <a href="kategoriler-<?php echo $kategoricek['seo_url'] ?>?masa_id_no=<?php echo $_GET['masa_id_no']; ?>" style='    font-family: "Quicksand","sans-serif";
    font-weight: 700;'> <?php echo  $kategoricek['kategori_ad']; ?> </a>
             </div>
            <span>
              <a href="kategoriler-<?php echo $kategoricek['seo_url'] ?>?masa_id_no=<?php echo $_GET['masa_id_no']; ?>" class="arrow-nav"> <i data-feather="chevron-right"></i></a></span>
          </div>
      <?php } ?>

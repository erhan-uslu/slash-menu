                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        ...
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tbody>
                                 <?php  
       $firma=$db->prepare("SELECT * FROM firma  where uyetur=?");  
       $firma->execute(array( '1' ));
                                   ...
                                   <td><?php echo $firmacek['sektor_ad']; ?></td>
                                    <?php if ($firmacek['vitrin']==1) {?> <td><a href="islemler/islem.php?normalv=<?php echo $firmacek['id']; ?>"><button type="button" class="btn btn-success btn-min-width box-shadow-2 mr-1 mb-1">Aktif</button></a></td> <?php } 
                                    else { ?>
                                  <td><a href="islemler/islem.php?vitrin=<?php echo $firmacek['id']; ?>"><button type="button" class="btn btn-danger btn-min-width box-shadow-2 mr-1 mb-1">Pasif</button></a></td>
                              <?php     } ?>

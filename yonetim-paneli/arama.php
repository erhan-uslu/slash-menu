    ...
    <div class="row">
        <div class="col-12">
            ...
            <fieldset class="form-group position-relative mb-0">                
                <input type="text" class="form-control form-control-xl input-xl" id="iconLeft1" name="arama" placeholder="Aramak için Dokun ...">
                    ...
                    <div class="card-body card-dashboard">
                        ...
                        <table class="table table-striped table-bordered zero-configuration">
                            ...
                            <tbody>
                                 ...
                                 else {$arama = $_GET['arama']; 
                                     $limit = 20000;
                                  }

       $firma=$db->prepare("SELECT * FROM firma WHERE firma  LIKE '%$arama%' Limit $limit");  
